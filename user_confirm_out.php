        ...
        <main>
            <div class="row g-5">
                <div class="col-md-7 col-lg-12" style="padding:50px 100px 0px 100px;">
                    ...
                    <form class="needs-validation" name="from1" method="post" action="save_orderout_user.php"
                        enctype="multipart/form-data">
                        <div class="row g-3">

                            <div class="col-sm-6">
                                <label for="firstName" class="form-label">ชื่อ</label>
                                <input type="hidden" class="form-control" id="id" name="id" placeholder="กรอกชื่อ"
