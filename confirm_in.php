        ...
        <main>
            <div class="row g-5">
                <div class="col-md-7 col-lg-12" style="padding:50px 100px 0px 100px;">
                    ...
                    <form class="needs-validation" name="from1" method="post" action="send_orderin.php" enctype="multipart/form-data">
                        <div class="row g-3">
                            <div class="col-sm-2">
                                <label for="firstName" class="form-label">คำนำหน้าชื่อ</label>
                                <input type="text" class="form-control" id="pre" name="pre" placeholder="คำหน้าหน้า" value="<?php echo $_SESSION['pre'] ?>" required="">
                            </div>
                            <div class="col-sm-5">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*?)\..*/g, '$1');" maxlength=3 class="form-control" id="passenger" name="passenger" placeholder="กรอกรายละเอียดการเดินทาง" value="<?php echo $_SESSION['passenger'] ?>" required="">
                                <div class="invalid-feedback">
                                    Valid is required.
                                </div>
                            </div>
