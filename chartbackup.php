        ...
        function showGraph(){
            {
                ...
                $.post("data.php", function(data) {
                    ...
                    let van = [];
                    for (let i in data) {
                        name.push(data[i].vehicle_id);
                        score.push(data[i].vehicle_id);
                        van.push(data[i].vehicle_id);
                    }
...
// ----------------------------------
            ...
            datasets: [{
             ...
             ,
             {
                ...
                data: score,
                fill: false,
                backgroundColor: 'rgba(54, 162, 20, 0.2)',
                // hoverBackgroundColor: '#CCCCCC',
                borderColor: 'rgba(54, 162, 235, 1)',
                borderWidth: 1
             ...
             ,
             {
                ...
                data: score,
                fill: false,
                backgroundColor: 'rgba(54, 20, 235, 0.2)',
                // hoverBackgroundColor: '#CCCCCC',
                borderColor: 'rgba(54, 162, 235, 1)',
                borderWidth: 1
